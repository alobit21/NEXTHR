...
const Usersidebar = () => {
  const menus = [
    { name: "Dashboard", link: "/admin/admindashbpage", icon: MdOutlineDashboard },
    { name: "Users", link: "/admin/adminusers", icon: AiOutlineUser },
    { name: "Applications", link: "/admin/adminapplications", icon: TbReportAnalytics },

    { name: "Opportunities", link: "/admin/adminopportunities", icon: FiMessageSquare },

    { name: "Setting", link: "/admin/adminsettings", icon: RiSettings4Line },
  ];
